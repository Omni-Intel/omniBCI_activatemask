...
class LocalClient:
    def __init__(self, url: str = "ws://127.0.0.1:8766/v1/stream", timeout: float = 5.0):
        parsed = urlsplit(url)
    ...
    def _open_stream(self, stream: str) -> _StreamIterator:
        ...
        try:
            ...
            if (
                ...
                or type(hello.get("sample_rate")) is not int
                or hello.get("sample_rate") not in (250, 500, 1000)
...
def connect_local(port: int = 8766, timeout: float = 5.0) -> LocalClient:
