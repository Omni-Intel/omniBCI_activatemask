...
constexpr char BLE_DEVICE_NAME[] = "OmniBCI-C3-SRB2";
...
bool setBulkChannelConfig(const uint8_t *payload) {
  ...
  currentReferenceMode = payload[0] == REFERENCE_SRB2
    ? REFERENCE_SRB2
    : REFERENCE_SRB1;
  currentEnabledMask = payload[1];
  currentBiasSensPMask = static_cast<uint8_t>(payload[2] & currentEnabledMask);
  currentSrb2Mask = static_cast<uint8_t>(payload[3] & currentEnabledMask);
