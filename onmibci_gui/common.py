...
# Keep pyqtgraph on the same Qt binding in normal runs and PyInstaller's
# isolated dependency-analysis subprocesses. Auto-detection can otherwise
# mistake PyInstaller's optional PyQt6 placeholder for an installed binding.
